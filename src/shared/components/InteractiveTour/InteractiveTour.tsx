  ...
  const mapSteps = (
    ...
    return compact(
      dbSteps.map((dbStep): Avo.InteractiveTour.Step | null => {
        ...
        mappedStep.content = (
          <Html content={dbStep.content as string} type="div" />
        );
        ...
        if (!document.querySelector(mappedStep.target)) {
          console.warn(
            `Could not find target for step "${mappedStep.title}}"`,
            {
    ...
    return (
      <div className="c-interactive-tour">
        <Joyride
          ...
          locale={{
            back: tText(
              'shared/components/interactive-tour/interactive-tour___terug',
            ),
            close: tText(
              'shared/components/interactive-tour/interactive-tour___sluit',
            ),
            last: tText(
              'shared/components/interactive-tour/interactive-tour___einde',
            ),
            next: tText(
