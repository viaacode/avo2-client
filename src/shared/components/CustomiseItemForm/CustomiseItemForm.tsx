...
import { type LabeledFormField } from '../../types/index';
import {
...
export type CustomiseItemFormDescriptionField = LabeledFormField &
...
export const CustomiseItemForm: FC<CustomiseItemFormProps> = ({
  ...
  return (
    <div className={wrapperClasses.join(' ')} style={style}>
      {preview && (
        <div className="c-customise-item-form__preview">{preview()}</div>
      )}
