      ...
      {showEducation && (
        <FormGroup
          label={
            educationLabel ||
            tText(
              'shared/components/lom-fields-input/lom-fields-input___onderwijs',
            )
          }
      ...
      {showEducationDegrees && !!educationDegreeOptions.length && (
        ...
        >
          <TagsInput
            ...
            value={
              getEducationLevelOptions([...lomFields.educationDegree]) || []
            }
            onChange={(values) =>
              handleChange(
                [
      ...
      {showThemes && !!allThemes?.length && (
        <FormGroup
          label={
            themesLabel ||
            tText(
              'shared/components/lom-fields-input/lom-fields-input___themas',
            )
          }
          labelFor="themeId"
      ...
      {showSubjects && (
        <FormGroup
          label={
            subjectsLabel ||
            tText(
              'shared/components/lom-fields-input/lom-fields-input___vakken',
            )
          }
          labelFor="subjectId"
