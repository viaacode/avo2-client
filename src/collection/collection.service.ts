...
export class CollectionService {
    ...
    try {
      if (!initialCollection?.management && updatedCollection?.management) {
        ...
        await CollectionService.insertManagementEntry(collectionId, {
          ...
          manager_profile_id:
            updatedCollection?.management?.manager_profile_id || null,
          status_valid_until:
            updatedCollection?.management?.status_valid_until || null,
      ...
      if (
        ...
        if (
          initialApprovedStatus !== updatedApprovedStatus &&
      ...
      throw new CustomError(
        'Failed to save management data to the database',
        err,
        {
          initialCollection,
          updatedCollection,
   ...
   */
  static deleteCollectionOrBundle = async (
  ...
  static async fetchCollectionsByTitleOrId(
    ...
    return CollectionService.fetchCollectionsOrBundlesByTitleOrId(
      true,
      titleOrId,
      limit,
    );
  ...
  public static async fetchCollectionOrBundleByIdOrInviteToken(
    ...
    try {
      ...
      throw new CustomError(
        'Failed to get collection or bundle with items',
        err,
        {
          collectionId,
          type,
  ...
  static async declineSharedCollection(
    collectionId: string,
    inviteToken: string,
  ): Promise<void> {
    try {
  ...
  static async insertCollectionLomLinks(
    collectionId: string,
    lomIds: string[],
  ): Promise<void> {
    try {
