    ...
    const COLLECTION_DROPDOWN_ITEMS = [
      ...createDropdownMenuItem(
        ...
        shouldDeleteSelfFromCollection
          ...
          : tText(
              'collection/components/collection-or-bundle-edit___verwijderen',
            ),
        'delete',
        true,
      ),
      ...createDropdownMenuItem(
        ...
        isCollection
          ? tText(
              'collection/components/collection-or-bundle-edit___voeg-item-toe',
            )
          : tText(
      ...
      <ButtonToolbar>
        {permissions.canPublish && (
          <Button
            type="secondary"
            disabled={
              unsavedChanges && !collectionState?.initialCollection?.is_public
            }
        ...
        <Button
          type="secondary"
          label={tText(
            'collection/components/collection-or-bundle-edit___bekijk',
          )}
          title={
            isCollection
              ? tText(
  ...
  const renderHeaderButtonsMobile = () => {
    ...
    const COLLECTION_DROPDOWN_ITEMS = [
      ...
      ...createDropdownMenuItem(
        ...
        isPublic
          ? tText(
              'collection/components/collection-or-bundle-edit___maak-prive',
            )
          : tText(
              'collection/components/collection-or-bundle-edit___publiceer',
            ),
      ...
      ...createDropdownMenuItem(
        ...
        isCollection
          ? 'Collectie hernoemen'
          : tText(
              'collection/components/collection-or-bundle-edit___bundel-hernoemen',
            ),
        IconName.folder,
        true,
      ),
    ...
    return (
      <div className="c-collection-or-bundle-edit">
        ...
        <DeleteCollectionModal
          ...
          contributorCount={
            collectionState.currentCollection?.contributors?.length || 0
          }
        ...
        <InputModal
          ...
          inputLabel={tText(
            'collection/components/collection-or-bundle-edit___id',
          )}
          inputPlaceholder={
            isCollection
              ? tText(
