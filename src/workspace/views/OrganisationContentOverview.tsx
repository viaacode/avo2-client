  ...
  const getColumns = (): TableColumn[] => {
    if (isMobileWidth()) {
      return [
        ...
        },
        {
          id: 'author',
          label: tText(
            'workspace/views/organisation-content-overview___auteur',
          ),
          col: '3',
          dataType: TableColumnDataType.string,
        },
    ...
    return [
      ...
      },
      {
        id: 'created_at',
        label: tText(
          'workspace/views/organisation-content-overview___aangemaakt',
        ),
        col: '1',
      ...
      },
      {
        id: 'updated_at',
        label: tText(
          'workspace/views/organisation-content-overview___laatst-bewerkt',
        ),
        col: '1',
        dataType: TableColumnDataType.dateTime,
      },
