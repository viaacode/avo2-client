...
import { TempAccess } from './user.types';
...
>[] = () => [
	{
		...
		error: i18n.t('De einddatum is verplicht en moet in de toekomst liggen'),
		isValid: (tempAccess: Partial<TempAccess>) =>
	...
	},
	{
		...
		error: i18n.t('De startdatum moet voor de einddatum liggen'),
		isValid: (tempAccess: Partial<TempAccess>) => {
...
export const getTempAccessValidationErrors = (tempAccess: TempAccess): string[] => {
