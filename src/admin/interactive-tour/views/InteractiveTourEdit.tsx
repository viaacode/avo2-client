    ...
    return (
      <>
                  ...
                  <Flex>
                    <FlexItem>
                      <Select
                        ...
                        onChange={(value) =>
                          setSelectedPageType(value as InteractiveTourPageType)
                        }
                      />
                    </FlexItem>
                    <FlexItem>
        ...
        <BlockHeading type="h3">
          {tText(
            'admin/interactive-tour/views/interactive-tour-edit___stappen',
          )}
        </BlockHeading>
        <InteractiveTourAdd
          index={0}
          ...
          changeInteractiveTourState={changeInteractiveTourState}
        />
        {(interactiveTourState.currentInteractiveTour.steps || []).map(
          renderStep,
        )}
      </>
    );
