...
export const Sidebar: FC<SidebarProps> = ({
    ...
    const renderedNavItems: ReactElement[] = flatten(
      (navItems || []).map((navItem, itemIndex): ReactElement[] => [
        ...
        ...(navItem.subLinks || []).map(
          (subLinkItem: NavigationItemInfo, subItemIndex) => {
  ...
  return (
    <div
      className={clsx(className, 'o-sidebar__avo', {
        'o-sidebar__avo--light': light,
      })}
    >
      {headerLink && (
        <div className="o-sidebar__avo__header">
          ...
          >
            <span
              title={tText(
                'admin/shared/components/sidebar/sidebar___homepagina',
              )}
            >
          ...
          >
            <span
              title={tText(
                'admin/shared/components/sidebar/sidebar___uitloggen',
              )}
            >
      ...
      <div className="o-sidebar__avo__content">
        {navItems ? (
          <ul className="o-sidebar__avo__nav c-bordered-list">
            {renderNavItems()}
          </ul>
        ) : (
          children
