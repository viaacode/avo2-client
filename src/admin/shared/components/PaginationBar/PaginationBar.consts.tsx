...
> {
	return {
		...
		firstLabel: tText('admin/shared/components/filter-table/filter-table___eerste'),
		firstIcon: <Icon name={IconName.chevronsLeft} />,
		lastLabel: tText('admin/shared/components/filter-table/filter-table___laatste'),
