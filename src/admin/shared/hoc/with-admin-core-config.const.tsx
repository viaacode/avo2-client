...
} from '../../../shared/services/toast-service.js'
...
const getAlertIconNames = (): Partial<Record<IconName, string>> => ({
  [IconName.notification]: tText(
    'admin/shared/hoc/with-admin-core-config___notificatie',
  ),
  [IconName.user]: tText('admin/shared/hoc/with-admin-core-config___gebruiker'),
  [IconName.alertCircle]: tText(
    'admin/shared/hoc/with-admin-core-config___waarschuwing-cirkel',
  ),
