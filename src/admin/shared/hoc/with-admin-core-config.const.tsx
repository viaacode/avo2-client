...
export function getAdminCoreConfig(): AdminConfig {
	...
	return {
		...
		routes: {
			...
			COLLECTIONS_OVERVIEW: APP_PATH.WORKSPACE_COLLECTIONS.route,
			COLLECTION_DETAIL: APP_PATH.COLLECTION_DETAIL.route,
			CONTENT_PAGE_CREATE: ADMIN_PATH.CONTENT_PAGE_CREATE,
			CONTENT_PAGE_DETAIL: ADMIN_PATH.CONTENT_PAGE_DETAIL,
			CONTENT_PAGE_EDIT: ADMIN_PATH.CONTENT_PAGE_EDIT,
			CONTENT_PAGE_LABEL_CREATE: ADMIN_PATH.CONTENT_PAGE_LABEL_CREATE,
			CONTENT_PAGE_LABEL_DETAIL: ADMIN_PATH.CONTENT_PAGE_LABEL_DETAIL,
			CONTENT_PAGE_LABEL_EDIT: ADMIN_PATH.CONTENT_PAGE_LABEL_EDIT,
			CONTENT_PAGE_LABEL_OVERVIEW: ADMIN_PATH.CONTENT_PAGE_LABEL_OVERVIEW,
			CONTENT_PAGE_OVERVIEW: ADMIN_PATH.CONTENT_PAGE_OVERVIEW,
			ITEM_DETAIL: APP_PATH.ITEM_DETAIL.route,
			NAVIGATION_CREATE: ADMIN_PATH.NAVIGATIONS_CREATE,
			NAVIGATION_DETAIL: ADMIN_PATH.NAVIGATIONS_DETAIL,
			NAVIGATION_ITEM_CREATE: ADMIN_PATH.NAVIGATIONS_ITEM_CREATE,
			NAVIGATION_ITEM_EDIT: ADMIN_PATH.NAVIGATIONS_ITEM_EDIT,
			NAVIGATION_OVERVIEW: ADMIN_PATH.NAVIGATIONS_OVERVIEW,
			NEWS: `/${ROUTE_PARTS.news}`,
			TRANSLATIONS_OVERVIEW: ADMIN_PATH.TRANSLATIONS,
			USER_DETAIL: ADMIN_PATH.USER_DETAIL,
			USER_EDIT: ADMIN_PATH.USER_EDIT,
			...
			USER_GROUP_OVERVIEW: ADMIN_PATH.USER_GROUP_OVERVIEW,
			USER_OVERVIEW: ADMIN_PATH.USER_OVERVIEW,
