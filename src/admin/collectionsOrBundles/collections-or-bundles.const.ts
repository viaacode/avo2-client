...
export const GET_USER_OVERVIEW_TABLE_COLS: () => FilterableColumn[] = () => [
	...
	// { id: 'bookmarks', icon: 'bookmark', tooltip: i18n.t('admin/collections-or-bundles/collections-or-bundles___gebookmarkt'), sortable: true },
	// { id: 'in_bundles', icon: 'folder', tooltip: i18n.t('admin/collections-or-bundles/collections-or-bundles___in-bundel'), sortable: true },
