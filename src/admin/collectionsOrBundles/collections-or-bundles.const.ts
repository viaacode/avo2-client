...
import { type DateRangeDropdownProps } from '../../shared/components/DateRangeDropdown/DateRangeDropdown.js'
...
const getCollectionAuthorUserGroupColumn = (
  ...
  label: tText(
    'admin/collections-or-bundles/collections-or-bundles___auteur-rol',
  ),
  sortable: true,
...
const getCollectionCreatedAtColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    id: 'created_at',
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___aangemaakt-op',
    ),
    sortable: true,
    visibleByDefault: true,
...
const getCollectionIsPublicColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    id: 'is_public',
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___publiek',
    ),
    sortable: true,
    visibleByDefault: true,
...
const getCollectionManagedColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    id: 'is_managed',
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___redactie',
    ),
    sortable: true,
    visibleByDefault: false,
    filterType: TableFilterType.BooleanCheckboxDropdown,
  ...
  return [
    {
      id: 'contributors',
      tooltip: tText(
        'admin/collections-or-bundles/collections-or-bundles___gedeeld',
      ),
...
const getCollectionEducationLevelsColumn = (
  ...
  id: 'education_levels',
  label: tText(
    'admin/collections-or-bundles/collections-or-bundles___onderwijsniveaus',
  ),
  sortable: false,
  visibleByDefault: false,
  filterType: TableFilterType.CheckboxDropdownModal,
...
const getCollectionEducationDegreesColumn = (
  ...
  label: tText(
    'admin/collections-or-bundles/collections-or-bundles___onderwijsgraden',
  ),
  sortable: false,
  visibleByDefault: false,
  filterType: TableFilterType.CheckboxDropdownModal,
...
const getCollectionOrganisationColumn = (
  ...
  id: 'organisation',
  label: tText(
    'admin/collections-or-bundles/collections-or-bundles___organisatie',
  ),
  sortable: false,
  visibleByDefault: false,
  filterType: TableFilterType.CheckboxDropdownModal,
...
const getActualisationStatusColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___status',
    ),
    sortable: true,
    visibleByDefault: true,
    filterType: TableFilterType.CheckboxDropdownModal,
...
const getActualisationStatusValidUntilColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___vervaldatum',
    ),
    sortable: true,
    visibleByDefault: true,
    filterType: TableFilterType.DateRangeDropdown,
...
const getActualisationApprovedAtColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___datum-goedkeuring',
    ),
    sortable: true,
    visibleByDefault: true,
    filterType: TableFilterType.DateRangeDropdown,
...
const getQualityCheckLanguageCheckColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___taalcheck',
    ),
    sortable: true,
    visibleByDefault: true,
    filterType: TableFilterType.BooleanCheckboxDropdown,
    filterProps: {
      trueLabel: tText(
        'admin/collections-or-bundles/collections-or-bundles___ok',
      ),
      falseLabel: tText(
        'admin/collections-or-bundles/collections-or-bundles___nok',
      ),
      includeEmpty: true,
...
const getQualityCheckQualityCheckColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___kwaliteitscontrole',
    ),
    sortable: true,
    visibleByDefault: true,
    filterType: TableFilterType.BooleanCheckboxDropdown,
...
const getMarcomLastCommunicationChannelTypeColumn = (
  ...
  filterProps: {
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___communicatietype',
    ),
...
const getMarcomLastCommunicationChannelNameColumn = (
  ...
  filterProps: {
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___communicatiekanaal',
    ),
...
const getMarcomKlascementColumn =
  (): FilterableColumn<CollectionTableColumns> => ({
    ...
    label: tText(
      'admin/collections-or-bundles/collections-or-bundles___klas-cement',
    ),
    sortable: true,
    visibleByDefault: true,
    dataType: TableColumnDataType.boolean,
...
export const GET_COLLECTIONS_COLUMNS = (
  ...
  getCollectionEducationLevelsColumn(
    educationLevelsAndDegrees.filter((item) => !item.broader),
  ),
  getCollectionEducationDegreesColumn(
    educationLevelsAndDegrees.filter((item) => !!item.broader),
  ),
