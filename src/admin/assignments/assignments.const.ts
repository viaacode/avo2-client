...
const getMarcomLastCommunicationAtColumn = (): FilterableColumn<AssignmentTableColumns> => ({
...
const getMarcomKlascementColumn = (): FilterableColumn<AssignmentTableColumns> => ({
...
export const GET_ASSIGNMENT_MARCOM_COLUMNS = (
	...
	getAssignmentSubjectsColumn(subjects),
	getAssignmentEducationLevelsColumn(educationLevelsAndDegrees.filter((item) => !item.broader)),
	getAssignmentEducationDegreesColumn(educationLevelsAndDegrees.filter((item) => !!item.broader)),
