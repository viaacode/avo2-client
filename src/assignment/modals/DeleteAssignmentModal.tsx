    ...
    <ConfirmModal
      ...
      title={
        shouldDeleteSelfFromAssignment
          ...
          : tHtml(
              'assignment/modals/delete-assignment-modal___verwijder-deze-opdracht',
            )
      }
      body={renderDeleteMessages()}
      cancelLabel={tText(
        'assignment/modals/delete-assignment-modal___annuleer',
      )}
      confirmLabel={tText(
        'assignment/modals/delete-assignment-modal___verwijder',
      )}
      size="large"
      onClose={onClose}
      className="c-content"
