...
export interface AssignmentFields {
  ...
  title: string;
  description: string;
  lom_learning_resource_type: AvoAssignmentType[] | null;
  ...
  blocks?: AvoAssignmentBlock[];
  labels?: { assignment_label: AvoAssignmentLabel }[];
  share_type?: AvoShareShareWithColleagueType; // Only available when fetching assignments from the assignments_v2_overview table
