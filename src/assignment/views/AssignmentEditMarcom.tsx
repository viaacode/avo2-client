...
export const AssignmentEditMarcom: FC<AssignmentEditMarcomProps> = ({
    ...
    return (
      <>
        <BlockHeading type="h3" className="u-padding-top u-padding-bottom">
          {tText(
            'assignment/views/assignment-edit-marcom___eerdere-communicatie',
          )}
        </BlockHeading>
        {marcomEntries ? (
          <>
    ...
    return (
      <>
        <BlockHeading type="h3">
          {tText(
            'assignment/views/assignment-edit-marcom___meest-recente-communicatie',
          )}
        </BlockHeading>
        <Flex justify="between" spaced="wide">
          ...
          <FlexItem>
            <FormGroup
              label={tText(
                'assignment/views/assignment-edit-marcom___kanaal-type',
              )}
            >
              <Select
          ...
          <FlexItem>
            <FormGroup
              label={tText(
                'assignment/views/assignment-edit-marcom___kanaal-naam',
              )}
            >
              <Select
          ...
          <FlexItem>
            <FormGroup
              label={tText('assignment/views/assignment-edit-marcom___link')}
            >
              <TextInput
          ...
          <FlexItem>
            <FormGroup label=" ">
              <Button
                label={tText(
                  'assignment/views/assignment-edit-marcom___toevoegen',
                )}
  ...
  const renderMarcomRemarksField = () => {
    return (
      <FormGroup
        label={tText('assignment/views/assignment-edit-marcom___opmerkingen')}
      >
        <TextArea
