  ...
  const saveAssignment = async () => {
    try {
      ...
      if (isCreatingAssignment) {
        ...
        if (
          originalAssignment?.owner_profile_id !== assignment.owner_profile_id
        ) {
          ...
          permissions.canPublish
            ? {
                ...
                ...(renderLabel
                  ? {
                      label: isPublic
                        ? tText('assignment/views/assignment-edit___maak-prive')
                        : tText('assignment/views/assignment-edit___publiceer'),
                    }
                  : {}),
                ariaLabel: isPublic
                  ? tText(
  ...
  const renderPageContent = () => {
    ...
    if (
      ...
      return (
        <ErrorNoAccess
          title={tHtml(
            'assignment/views/assignment-edit___je-hebt-geen-toegang',
          )}
          message={tHtml(
