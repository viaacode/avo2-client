export enum PermissionName {
	...
	EDIT_ASSIGNMENTS = 'EDIT_ASSIGNMENTS', // DEPRECATED use EDIT_OWN_ASSIGNMENTS instead
	...
	QUICK_LANE__SHARE_WITH_STUDENTS = 'QUICK_LANE__SHARE_WITH_STUDENTS',
	QUICK_LANE__VIEW_URLS = 'QUICK_LANE__VIEW_URLS',
}
