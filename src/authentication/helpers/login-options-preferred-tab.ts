...
const LOGIN_OPTIONS_PREFERRED_TAB_LOCAL_STORAGE_KEY = 'AVO.login_options_preferred_tab';
...
export function setPreferredLoginOption(id: string | number) {
	localStorage.setItem(LOGIN_OPTIONS_PREFERRED_TAB_LOCAL_STORAGE_KEY, id.toString());
}
