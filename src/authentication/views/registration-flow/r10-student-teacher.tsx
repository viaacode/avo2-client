...
const StudentTeacher: FunctionComponent<StudentTeacherProps> = () => {
		...
		<Container className="c-register-stamboek-view" mode="vertical">
			<Container mode="horizontal" size="large">
				<div className="c-content">
					<Heading type="h2">
						<Trans i18nKey="authentication/views/registration-flow/r-10-student-teacher___het-archief-voor-onderwijs-voor-student-leerkrachten">Het Archief voor Onderwijs voor Student-leerkrachten</Trans>
					</Heading>
					<p>
						<Trans i18nKey="authentication/views/registration-flow/r-10-student-teacher___student-teacher-description">Jij zoekt meer en dat vinden wij top!
 <br />
 <br />
 ...
 onderwijsinstelling. Hou rekening met een verwerkingstijd van gemiddeld een werkweek.</Trans>
					</p>
				</div>
			</Container>
		</Container>
