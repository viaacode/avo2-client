				...
				<div className="c-content">
					...
					<p>
						<Trans i18nKey="authentication/views/registration-flow/r-10-student-teacher___student-teacher-description">
							...
							<a href="mailto:support@meemoo.be">support@meemoo.be</a> met inbegrip van een lijst
							(excel of csv) met de voornaam, achternaam en het e-mailadres van de student aan de
