						...
						<Toolbar>
							<ToolbarLeft>
								<ToolbarItem>
									...
									<MetaData spaced={true} category={itemMetaData.type.label}>
										<MetaDataItem>
									...
									<ul className="c-media-card-list">
										<li style={relatedItemStyle}>
											<MediaCard
												...
												category={itemMetaData.type.label || 'video'}
