...
export const ArrowDownCircle = (props: SVGProps<SVGSVGElement>) => (
	<svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path
			d="M12 17a.997.997 0 0 1-.707-.293l-4-4a.999.999 0 1 1 1.414-1.414L12 14.586l3.293-3.293a.999.999 0 1 1 1.414 1.414l-4 4A.997.997 0 0 1 12 17z"
			fill="#000"
		/>
		<path d="M12 17a1 1 0 0 1-1-1V8a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1z" fill="#000" />
	</svg>
);
