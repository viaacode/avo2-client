...
export const ZoomIn = (props: SVGProps<SVGSVGElement>) => (
	<svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path
			d="M21 22a.997.997 0 0 1-.707-.293l-4.35-4.35a.999.999 0 1 1 1.414-1.414l4.35 4.35A.999.999 0 0 1 21 22zM11 15a1 1 0 0 1-1-1V8a1 1 0 0 1 2 0v6a1 1 0 0 1-1 1z"
			fill="#000"
		/>
		<path d="M14 12H8a1 1 0 0 1 0-2h6a1 1 0 1 1 0 2z" fill="#000" />
	</svg>
);
