...
(0, test_1.test)('T51: Bundel bewerken', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var collectionTitle, collectionTitleInOverview, date, bundleTitle, date2, collectionTitle2, collectionTitleInOverview2, bundleTitleInOverview, title1, title2, title1AfterChangeOrder, title2AfterChangeOrder;
    var page = _b.page;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, login_onderwijs_avo_1.loginOnderwijsAvo)(page, process.env.TEST_CLIENT_ENDPOINT, process.env.TEST_EDUCATIEVE_AUTEUR_USER, process.env.TEST_EDUCATIEVE_AUTEUR_PASS)];
            case 2:
                // Login as Educatieve auteur
                _c.sent();
            ...
            case 7:
                ...
                return [4 /*yield*/, page
                        .locator('div.c-toolbar__right > div > div > div.c-dropdown__content-open > div > div:nth-child(1)')
                        .click()];
            case 8:
                // Add collection to bundle
                _c.sent();
                // Check add to bundle modal opened
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('heading', { name: 'Voeg collectie toe aan bundel' })).toBeVisible()];
            case 9:
                // Check add to bundle modal opened
                _c.sent();
                // Check new bundle option
                return [4 /*yield*/, page
                        .locator('div.c-modal__body > div > div > div > div > div > div:nth-child(2) > div.c-radio > label > input[type=radio]')
                        .check()];
            case 10:
                // Check new bundle option
                _c.sent();
                ...
                return [4 /*yield*/, page.fill("input[placeHolder='Titel van de bundel']", bundleTitle)];
            case 11:
                _c.sent();
            ...
            case 13:
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.locator('div > div.Toastify__toast-body > div > div > div.c-alert__message')).toContainText('De collectie is toegevoegd aan de bundel.')];
            case 14:
                // Check toast message was succesful
                _c.sent();
                // Click search button
            ...
            case 16:
                ...
                return [4 /*yield*/, page.getByRole('button', { name: 'Type' }).click()];
            case 17:
                // Select video checkbox and search
                _c.sent();
            ...
            case 20:
                ...
                _c.sent();
                // Click second item
                return [4 /*yield*/, page.getByRole('link', { name: 'KLAAR: phishing' }).click()];
            case 21:
                // Click second item
                _c.sent();
            ...
            case 24:
                ...
                return [4 /*yield*/, page.getByLabel('Voeg toe aan een nieuwe').setChecked(true)];
            case 25:
                // Select new collection radiobutton
                _c.sent();
                date2 = new Date();
                collectionTitle2 = 'Aangemaakt door automatische test ' + date2;
                return [4 /*yield*/, page.fill("input[placeHolder='Collectietitel']", collectionTitle2)];
            case 26:
                _c.sent();
            ...
            case 30:
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: collectionTitleInOverview2 }).first()).toBeVisible()];
            case 31:
                _c.sent();
                // Click on the above link
                return [4 /*yield*/, page.getByRole('link', { name: collectionTitleInOverview2 }).first().click()];
            case 32:
                // Click on the above link
                _c.sent();
                // Open options of the newly created collection
            ...
            case 36:
                ...
                return [4 /*yield*/, page.getByText(bundleTitle, { exact: true }).click()];
            case 37:
                // Select existing bundle created earlier in the test
                _c.sent();
                // Wait for previous toast to disappear
            ...
            case 39:
                ...
                _c.sent();
                // Check toast message was succesful
                return [4 /*yield*/, (0, test_1.expect)(page.getByText('De collectie is toegevoegd aan de bundel.')).toBeVisible()];
            case 40:
                // Check toast message was succesful
                _c.sent();
                // Go to werkruimte
            ...
            case 43:
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: bundleTitleInOverview })).toBeVisible()];
            case 44:
                _c.sent();
                return [4 /*yield*/, page.waitForTimeout(2000)];
            case 45:
                _c.sent();
                // Click on the above link
                return [4 /*yield*/, page.getByRole('link', { name: bundleTitleInOverview }).click()];
            case 46:
                // Click on the above link
                _c.sent();
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('heading', { name: 'Over deze bundel' })).toBeVisible()];
            case 47:
                // Check bundle page is opened
                // await page.waitForTimeout(2000);
                // await page.screenshot({ path: 'screenshot.png', fullPage: true });
                _c.sent();
                return [4 /*yield*/, page
                        .locator('div.m-bundle-detail > div > div:nth-child(2) > div > div > div > div:nth-child(1) > a > div > div.c-media-card-content > h4')
                        .textContent()];
            case 48:
                title1 = _c.sent();
                return [4 /*yield*/, page
                        .locator('div.m-bundle-detail > div > div:nth-child(2) > div > div > div > div:nth-child(2) > a > div > div.c-media-card-content > h4')
                        .textContent()];
            case 49:
                title2 = _c.sent();
                // Edit bundle
            ...
            case 51:
                _c.sent();
                return [4 /*yield*/, (0, test_1.expect)(page.locator('button[aria-label="Verplaats naar boven"]')).toBeVisible()];
            case 52:
                _c.sent();
                // Move second item up
                return [4 /*yield*/, page.locator('button[aria-label="Verplaats naar boven"]').click()];
            case 53:
                // Move second item up
                _c.sent();
            ...
            case 56:
                _c.sent();
                // Check toast message was succesful
                return [4 /*yield*/, (0, test_1.expect)(page.getByText('De bundel werd opgeslagen.')).toBeVisible()];
            case 57:
                // Check toast message was succesful
                _c.sent();
                // Close edit mode
            ...
            case 61:
                ...
                (0, test_1.expect)(title1 !== title1AfterChangeOrder && title2 !== title2AfterChangeOrder).toBeTruthy();
                // CLEANUP
                // REMOVE BUNDLE
                // Open options of the newly created bundle
                return [4 /*yield*/, page.getByRole('button', { name: 'Meer opties' }).click()];
            case 62:
                // CLEANUP
                // REMOVE BUNDLE
                // Open options of the newly created bundle
                _c.sent();
                // Click 'Verwijderen'
                return [4 /*yield*/, page.locator('div.c-dropdown__content-open > div > div:nth-child(2)').click()];
            case 63:
                // Click 'Verwijderen'
                _c.sent();
            ...
            case 64:
                ...
                _c.sent();
                // Check toast message was succesful
                return [4 /*yield*/, (0, test_1.expect)(page.getByText('De bundel werd succesvol verwijderd. Collecties bleven ongewijzigd.')).toBeVisible()];
            case 65:
                // Check toast message was succesful
                _c.sent();
                //REMOVE COLLECTIONS
            ...
            case 68:
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: collectionTitleInOverview2 })).not.toBeVisible()];
            case 69:
                // Check new collection is removed
                _c.sent();
                // Open options of the newly created collection
