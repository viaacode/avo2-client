 ...
 *
 */
(0, test_1.test)('T16: Beheer - Contentpagina publiceren', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 17:
                _c.sent();
                // Publish
                return [4 /*yield*/, page.locator('button[aria-label="Maak de contentpagina publiek / niet-publiek"]').click()];
            case 18:
                // Publish
                _c.sent();
                return [4 /*yield*/, page.waitForTimeout(1000)];
            case 19:
                _c.sent();
                // Check modal opens
                return [4 /*yield*/, (0, test_1.expect)(page.getByRole('heading', { name: 'Maak deze contentpagina publiek.', exact: true })).toBeVisible()];
            case 20:
                // Check modal opens
                _c.sent();
                // Select public option
                return [4 /*yield*/, page.locator('input[value="public"]').check()];
            case 21:
                // Select public option
                _c.sent();
                return [4 /*yield*/, page.waitForTimeout(1000)];
            ...
            case 24:
                ...
                return [4 /*yield*/, (0, test_1.expect)(page.locator('div > div.Toastify__toast-body > div > div > div.c-alert__message')).toContainText('De contentpagina is nu publiek.')];
            case 25:
                // Check page is public
                _c.sent();
                return [4 /*yield*/, page.waitForTimeout(1000)];
