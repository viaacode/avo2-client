 ...
 *
 */
(0, test_1.test)('T12: Zoeken - zoeken op keyword', function (_a) {
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            page
              .getByRole('link', { name: 'Zoeken', exact: true })
              .click(),
        ...
        case 8:
          ...
          return [
            4 /*yield*/,
            page
              .locator('.c-thumbnail-meta--img-is-loaded')
              .first()
              .click(),
        ...
        case 9:
          ...
          return [
            4 /*yield*/,
            (0, test_1.expect)(
              page.locator('h2.c-item-detail__header'),
            ).toContainText('Test'),
          ];
        case 10:
          // Check title and body contains test
