...
(0, test_1.test)(
  'T64: Onderwijsniveau kiezen voor secundair onderwijs',
  function (_a) {
        ...
        switch (_d.label) {
          ...
          case 1:
            ...
            return [
              ...
              (0, login_onderwijs_avo_1.loginOnderwijsAvo)(
                page,
                process.env.TEST_CLIENT_ENDPOINT,
                process.env.TEST_LESGEVER_SECUNDAIR_GEBRUIKER_USER,
                process.env.TEST_LESGEVER_SECUNDAIR_GEBRUIKER_PASS,
              ),
            ];
          case 2:
            _d.sent();
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              page.goto(
                ''.concat(process.env.TEST_CLIENT_ENDPOINT, 'opdrachten/maak'),
              ),
            ];
          case 4:
            _d.sent();
