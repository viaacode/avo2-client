...
import { loginOnderwijsHetArchief } from '../helpers/login-onderwijs-het-archief';

/**
 * New: https://docs.google.com/spreadsheets/d/1IvhK0v0HSntCwTcXiFseHargwwWwpoCkDMjmMehaDMA/edit#gid=0
 */

test('T01: Inloggen basisgebruiker', async ({ page, context }) => {
	...
	await loginOnderwijsHetArchief(
		page,
		process.env.TEST_CLIENT_ENDPOINT as string,
