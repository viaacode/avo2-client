...
test.skip('T09: Nieuws - klikken op pills', async ({ page, context }) => {
	...
	await expect(page.locator('li.c-tag').filter({ hasText: pillName })).toBeVisible();
	// Check that pill is not active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName })).not.toBeVisible();

	// Click on non-active pill
	await page.locator('li.c-tag').filter({ hasText: pillName }).click();
	// Check pill is active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName })).toBeVisible();
	...
	// Should be the same
	await expect(page.locator('a.c-content-page__label').filter({ hasText: pillName })).toHaveCount(
		count
	);
	...
	// Check pill is visible
	await expect(page.locator('li.c-tag').filter({ hasText: pillName2 })).toBeVisible();
	// Check that pill is not active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName2 })).not.toBeVisible();

	// Click on non-active pill
	await page.locator('li.c-tag').filter({ hasText: pillName2 }).click();
	// Check pill is active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName2 })).toBeVisible();
	...
	// Check pill is visible
	await expect(page.locator('li.c-tag').filter({ hasText: pillName3 })).toBeVisible();
	// Check that pill is not active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName3 })).not.toBeVisible();

	// Click on non-active pill
	await page.locator('li.c-tag').filter({ hasText: pillName3 }).click();
	// Check pill is active
	await expect(page.locator('li.c-tag__active').filter({ hasText: pillName3 })).toBeVisible();
